  ...
  const [memoryItems] = useState<MemoryItem[]>([
    {
      ...
      content:
        "Discusión sobre mejores prácticas en React, hooks y optimización de rendimiento...",
    ...
    },
    {
      ...
      content:
        "Información extraída sobre utilidades de Tailwind, configuración y personalización...",
    ...
    },
    {
      ...
      content:
        "Aprendizaje sobre singleton, factory, observer y otros patrones implementados en TS...",
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-blue-200">
              Base de conocimiento personal y persistente
            </p>
          </div>
      ...
      <div className="grid gap-4">
        {filteredItems.map((item) => (
          <div
            key={item.id}
            className="glass-morphism rounded-xl p-6 hover:bg-slate-800/30 transition-all"
          >
        ...
        <div className="glass-morphism rounded-xl p-12 text-center">
          ...
          <p className="text-blue-200">
            {searchTerm
              ...
              : "Aún no hay datos almacenados en mi memoria"}
          </p>
        </div>
      )}
    </div>
